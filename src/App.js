                ...
                <ul>
                  <li className="submenu">
                    ...
                    <ul>
                      ...
                      <li className="third-level"><a href="javascript:void(0);">Revolution slider</a>
                        ...
                        <ul>
                          ...
                          <li><a href="index_15.html">Vimeo Hero</a></li><div>
                                  ...
                                  <nav className="col-9">
                                    ...
                                    <div className="main-menu">
                                      ...
                                      <ul>
                                        ...
                                        <li className="submenu">
                                          <a href="javascript:void(0);" className="show-submenu">Hotels <i className="icon-down-open-mini"></i></a><ul>
                            ...
                            <div id="sign-in-dialog" className="zoom-anim-dialog mfp-hide">
                              ...
                              <form>
                                <div className="sign-in-wrapper">
                                  ...
                                  <div className="text-center"><input type="submit" className="btn_login" /></div>
                                  ...
                                  <div id="forgot_pw">
                                    ...
                                    <div className="text-center"><input type="submit" className="btn_1" /></div>
                                  </div>
                                </div>
                              </form>
